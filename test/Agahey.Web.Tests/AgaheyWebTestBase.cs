...
{
    public abstract class AgaheyWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static AgaheyWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(AgaheyWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<AgaheyDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<AgaheyDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<AgaheyDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<AgaheyDbContext, Task<T>> func)
        {
            T result;
