...
using Agahey.Sessions;
using Agahey.Web.Models.Account;
using Agahey.Web.Views.Shared.Components.TenantChange;

namespace Agahey.Web.Controllers
{
    public class AccountController : AgaheyControllerBase
    {
